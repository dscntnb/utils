 ...
 *
 *	 	月前半の交通費を表示: 例) 10日間
 *	 		$ php bus_fee_one_way.php 10
 *	 	出力結果
 *	 		10: 3760
 *
 *	 	月後半の交通費を表示: 例) 前半10日間、後半10日間の場合
 *	 		$ php bus_fee_one_way.php 10 10
 *	 	出力結果
 *	 		10(20): 3280(7040 - 3760)
 *
 * @param $argv[1] (optional) 月前半の回数
 * @param $argv[2] (optional) 月後半の回数
 */
